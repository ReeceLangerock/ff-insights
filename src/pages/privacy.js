...
const IndexPage = () => (
  <Layout>
    ...
    <h1 style={{marginTop: '4rem'}}>Insightful's Privacy Policy</h1>
    <p>
      Jetsweep Studios operates the Insightful.tk website, which provides the
      Fantasy Football Insight service.
    </p>
    <p>
      This page is used to inform website visitors regarding our policies with
      the collection, use, and disclosure of Personal Information if anyone
      decided to use our Service, the Insightful website.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which is accessible at Insightful.tk, unless
    ...
    <p>
      ...
      not limited to your name, phone number, and postal address. We currently
      only require your email address. The information that we collect will be
